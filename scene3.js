  ...
  d3.csv(dataURL).then((data) => {
    ...
    if (selectedAirlineData) {
      ...
      const airlineData = [
        {
          label: "Incidents",
          value: +selectedAirlineData.incidents_00_14,
          color: "#1f77b4",
        },
        {
          label: "Fatal Accidents",
          value: +selectedAirlineData.fatal_accidents_00_14,
          color: "#ff7f0e",
        },
        {
          label: "Fatalities",
          value: +selectedAirlineData.fatalities_00_14,
          color: "#d62728",
        },
      ];
      ...
      const sortedIncidentsData = data
        .slice()
        .sort((a, b) => b.incidents_00_14 - a.incidents_00_14);

      const sortedFatalAccidentsData = data
        .slice()
        .sort((a, b) => b.fatal_accidents_00_14 - a.fatal_accidents_00_14);
      ...
      svg
        ...
        .attr("y", -5)
        .attr("text-anchor", "middle")
        .text(`Safety Records for ${selectedAirline} (2000-2014)`);
...
function updateHighestData(data, numRecords) {
  ...
  for (let i = 0; i < numRecords; i++) {
    ...
    row
      .append("td")
      .text(sortedData[i].incidents_00_14)
      .attr("style", "border: 1px solid black; padding: 8px;")
      .attr("align", "left");
    row
      .append("td")
      .text(sortedData[i].fatal_accidents_00_14)
      .attr("style", "border: 1px solid black; padding: 8px;")
      .attr("align", "left");
    row
      .append("td")
      .text(sortedData[i].fatalities_00_14)
      .attr("style", "border: 1px solid black; padding: 8px;")
      .attr("align", "left");
  }
}
